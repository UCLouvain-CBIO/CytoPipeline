...
## Session information
    ...
    ## [1] ggplot2_4.0.3       reshape2_1.4.5      CytoPipeline_1.13.1
    ## [4] BiocStyle_2.41.0   
    ## 
    ## loaded via a namespace (and not attached):
    ##   [1] changepoint_2.3       tidyselect_1.2.1      dplyr_1.2.1          
    ##   [4] farver_2.1.2          blob_1.3.0            filelock_1.0.3       
    ##   [7] S7_0.2.2              fastmap_1.2.0         BiocFileCache_3.3.0  
    ##  [10] XML_3.99-0.23         digest_0.6.39         lifecycle_1.0.5      
    ##  [13] cluster_2.1.8.3       RSQLite_3.53.3        magrittr_2.0.5       
    ...
    ##  [25] bit_4.6.0             curl_7.1.0            diagram_1.6.5        
    ##  [28] plyr_1.8.9            RColorBrewer_1.1-3    withr_3.0.3          
    ##  [31] purrr_1.2.2           RProtoBufLib_2.25.0   BiocGenerics_0.59.11 
    ##  [34] PeacoQC_1.23.0        desc_1.4.3            grid_4.6.1           
    ##  [37] stats4_4.6.1          flowAI_1.43.0         colorspace_2.1-3     
    ##  [40] scales_1.4.0          iterators_1.0.14      cli_3.6.6            
    ##  [43] rmarkdown_2.31        crayon_1.5.3          ragg_1.5.2           
    ##  [46] ncdfFlow_2.59.1       generics_0.1.4        otel_0.2.0           
    ##  [49] rjson_0.2.23          DBI_1.3.0             cachem_1.1.0         
    ##  [52] flowCore_2.25.1       stringr_1.6.0         parallel_4.6.1       
    ##  [55] BiocManager_1.30.27   matrixStats_1.5.0     vctrs_0.7.3          
    ##  [58] jsonlite_2.0.0        cytolib_2.25.0        bookdown_0.47        
    ##  [61] IRanges_2.47.2        GetoptLong_1.1.1      S4Vectors_0.51.6     
    ##  [64] bit64_4.8.2           clue_0.3-68           Rgraphviz_2.57.0     
    ##  [67] systemfonts_1.3.2     foreach_1.5.2         jquerylib_0.1.4      
    ##  [70] hexbin_1.28.6         glue_1.8.1            pkgdown_2.2.1.9000   
    ##  [73] codetools_0.2-20      stringi_1.8.9         shape_1.4.6.1        
    ##  [76] gtable_0.3.6          ggcyto_1.41.1         ComplexHeatmap_2.29.0
    ##  [79] tibble_3.3.1          pillar_1.11.1         htmltools_0.5.9      
    ##  [82] graph_1.91.0          circlize_0.4.18       R6_2.6.1             
    ##  [85] dbplyr_2.6.0          httr2_1.3.0           textshaping_1.0.5    
    ##  [88] doParallel_1.0.17     evaluate_1.0.5        flowWorkspace_4.25.1 
    ##  [91] lattice_0.22-9        Biobase_2.73.2        png_0.1-9            
    ##  [94] memoise_2.0.1         bslib_0.12.0          Rcpp_1.1.2           
    ##  [97] gridExtra_2.3.1       xfun_0.60             zoo_1.9-0            
    ## [100] fs_2.1.0              pkgconfig_2.0.3       GlobalOptions_0.1.4
