# License
    ...
    CytoPipeline Licensing
    ============================================

    This file attempts to include all licenses that apply within CytoPipeline (this program) source tree, in particular any that are supposed to be exposed to the end user for credit requirements for instance.
    ...
    *************************************************************************
    ...
    It can be found here:  https://github.com/UCLouvain-CBIO/CytoPipeline
