...
vignette: >
  %\VignetteIndexEntry{Automation and Visualization of Flow Cytometry 
...
```{r scaleTransformQueueDisplay, results='markup', 
fig.cap="Scale transform processing queue", echo=FALSE, out.width='75%', 
...
```{r preProcessingQueueDisplay, results='markup', 
fig.cap="Pre-processing queue for two different pipeline settings", 
echo=FALSE, out.width='100%', fig.align='center', fig.wide = TRUE}
