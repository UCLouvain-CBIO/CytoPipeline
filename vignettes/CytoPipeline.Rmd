...
vignette: >
  %\VignetteIndexEntry{Automation and Visualization of Flow Cytometry Data 
  Analysis Pipelines}
...
A subsampling of this public dataset is built-in in the `CytoPipeline` 
...
# example of retrieving a transformList

# example of retrieving another object
